...
- **Multi-template pipelines** — Orchestrate ≥2 template streams into shared outputs with weighted selection.
...
- **CI & coverage** — GitHub Actions CI with ≥60% coverage on `src/meltr`; PyPI publish workflow via Trusted Publisher (OIDC).
