...
@app.command("init")
def init_command(
    directory: Optional[str] = typer.Option(None, "--directory", "-d", help="Installation directory (default: ./meltr)"),
    ...
    user: Optional[str] = typer.Option(None, "--user", "-u", help="Service user to create or use (default: meltr)"),
...
def main_callback(
    ctx: typer.Context,
    api_url: Optional[str] = typer.Option(None, "--api-url", envvar="MELTR_API_URL", help="API server URL"),
    api_key: Optional[str] = typer.Option(None, "--api-key", envvar="MELTR_API_KEY", help="API key for authentication"),
