...
from meltr.telemetry import get_actor_id
...
class CommunityAPIClient:
    ...
    def get_product_detail(self, vendor_id: str, product_id: str) -> dict[str, Any]:
    ...
    def get_data_source_detail(
        self, vendor_id: str, product_id: str, data_source_id: str
    ) -> dict[str, Any]:
        ...
        """
        return self._request("GET", f"/vendors/{vendor_id}/{product_id}/{data_source_id}")

    def get_template_detail(
        self, vendor_id: str, product_id: str, data_source_id: str, template_id: str
    ) -> dict[str, Any]:
        ...
        return self._request(
            "GET", f"/vendors/{vendor_id}/{product_id}/{data_source_id}/{template_id}"
        )
