...
class TemplateMetadata(BaseModel):
    ...
    # Optional fields
    frequency: str | None = Field(default=None, description="Event frequency category")
    is_generator: bool = Field(default=False, description="Whether template is used for generation")
    base_frequency: float | None = Field(default=None, description="Base events per hour")
    time_patterns: list[str] | None = Field(default=None, description="Time patterns")
    business_hours_multiplier: float | None = Field(
        default=None, description="Business hours multiplier"
    )
    night_hours_multiplier: float | None = Field(default=None, description="Night hours multiplier")
    weekend_multiplier: float | None = Field(default=None, description="Weekend multiplier")
    documentation: dict[str, Any] | None = Field(default=None, description="Documentation object")
