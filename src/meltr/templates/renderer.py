...
from meltr.templates.filters import register_filters
...
class TemplateRenderer:
    ...
    def __init__(self, registry: EntityRegistry, timezone: str | None = None) -> None:
        ...
        from meltr.templates.filters import now as now_func
    ...
    def render_template(self, template_path: str, context: dict[str, Any] | None = None) -> str:
