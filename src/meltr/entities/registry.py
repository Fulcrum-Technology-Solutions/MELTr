...
class EntityRegistry:
    ...
    def get_organization_contact(self, role: str) -> str | None:
    ...
    def get_random_user(self) -> dict[str, Any] | None:
    ...
    def get_random_device(self) -> dict[str, Any] | None:
    ...
    def get_random_service(self) -> dict[str, Any] | None:
