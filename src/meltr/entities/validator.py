...
def validate_entities(data: Dict[str, Any], schema_path: Optional[Path] = None) -> None:
...
def _validate_user_uniqueness(user: Dict[str, Any], index: int, usernames: set, emails: set) -> None:
