...
def telemetry_enabled() -> bool:
    ...
    - LOGFORGE_TELEMETRY=0 disables
    - LOGFORGE_TELEMETRY=false disables
    """
    v = os.getenv("LOGFORGE_TELEMETRY", "").strip().lower()
...
def get_actor_id(home: Optional[Path] = None) -> str:
    """
    Anonymous stable client identifier stored under LOGFORGE_HOME.
    """
...
class TelemetryClient:
    ...
    def post_events(self, *, actor_id: str, events: List[TelemetryEvent]) -> None:
        ...
        headers = {
            ...
            "X-LogForge-Actor-Id": actor_id,
            "User-Agent": f"LogForge-OSS/{__version__}",
        }
